...
import com.hutu.modules.admin.followup.mapper.AdminSolutionNodeMapper;
 ...
 */
@Service
public class AdminSolutionNodeServiceImpl extends ServiceImpl<AdminSolutionNodeMapper, SolutionNode> implements AdminSolutionNodeService {
    @Autowired
    private AdminSolutionService adminSolutionService;
    @Autowired
    private AdminSolutionNodeMapper mapper;
    ...
    @Override
    public int totalRecordMax(Integer solutionId) {
        return mapper.totalRecordMax(solutionId);
    }
}
