...
public class SignHelper {
    private static String PublicKe = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCcKVz9+3Kpspz8ajwF3CZ7XqsA1lSLHK46EG4ckkacWXfDO/z8jXaDHhooAj9ydIZm4dHOEIa65//S2R7n55xg2Fb2kxGmdRYZJn+Y37KhXQu6JokYPG6G1f3F7IXVsrH8KyYs4q4eeCn1zC+itunSQgMB2xt2wzH27gcpfm9N9QIDAQAB";
    ...
    public static boolean verify(String tokenStr,String signStr){
        Sign sign = SecureUtil.sign(SignAlgorithm.MD5withRSA,null,PublicKe);
